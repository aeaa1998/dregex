...
class MyCOCORParser(
    ...
    fun IgnoreCase() {
        ...
        val stringValue = Composition<String>("");
        val identName2 = Composition<String>("");
        val stringValue2 = Composition<String>("");
        ...
        while (listOf<String>(
                ...
                "charinterval",
                "string"
            ).contains(nextTokenMatch.token.ident)
        ) {
    ...
    fun Atributos() {
        ...
        while (listOf<String>("raw <").contains(nextTokenMatch.token.ident) || listOf<String>(
                "ident",
                "string",
                "char",
                "charnumber",
